...
class HomeScreen extends StatelessWidget {
  ...
  // Helper widget to build the information rows beautifully
  ...
  Widget build(BuildContext context) {
    ...
    // Extract user details safely for the welcoming UI
    ...
    return Scaffold(
      backgroundColor: const Color(0xFF022C22), // Deep forest green backdrop
      
      // ==========================================
      // DRAWER: Only exists if the user is logged in
      // ==========================================
      drawer: isLoggedIn
          ? Drawer(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                  ...
                  SafeArea(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          // LEFT SIDE: Hamburger if logged in, Text if not.
                          isLoggedIn
                              ? Builder(
                          ...
                          // CENTER: Show LakbAi in the middle only if the hamburger is taking up the left side
                          if (isLoggedIn)
                            const Text('LakbAi', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: 1.5)),

                          // RIGHT SIDE: Invisible spacer if logged in, Sign In button if not.
                          isLoggedIn
                              ? const SizedBox(width: 48) // Invisible box to keep "LakbAi" perfectly centered
                              : ElevatedButton.icon(
            ...
            // ==========================================
            // 2. INFORMATION SECTION (Below the fold)
            // ==========================================
            Container(
              width: double.infinity,
