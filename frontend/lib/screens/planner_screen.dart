...
class _PlannerScreenState extends State<PlannerScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<ItineraryProvider>(context, listen: false).fetchSavedItineraries();
    });
  }
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              Provider.of<ItineraryProvider>(context, listen: false).updateItinerary(item['_id'], updated);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer2<ItineraryProvider, DestinationsProvider>(
                          ...
                          children: [
                            ...
                            OverflowBar(
                              children: [
                                ...
                                TextButton.icon(
                                  onPressed: () => Provider.of<ItineraryProvider>(context, listen: false).deleteItinerary(id), 
